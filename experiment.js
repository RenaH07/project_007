...
timeline.push({
  ...
  stimulus: `
   <h3>操作説明</h3>
   <p>今から、黒い丸が画面内を動く短い動画が再生されます。</p>
   <p>動画によっては、黒い丸が画面上の障害物にぶつかることがありますが、これらはすべて実験の一部であり、不具合ではありません。</p>
   <p>再生が終わると、質問が表示されます。各動画について、動画に表示される<strong>「黒い丸」</strong>の動き全体の印象を評価してください。</p>
...
async function main(){
  ...
  timeline.push({
   ...
   stimulus: `
      <h3>本番開始</h3>
      <p>ここからが本番です。</p>
      <p>今から、黒い丸が画面内を動く短い動画が順番に再生されます。動画によっては、黒い丸が画面上の障害物にぶつかることがありますが、これらはすべて実験の一部であり、不具合ではありません。</p>
      <p>再生が終わると、質問が表示されます。先ほどと同様に、各動画について動画に表示される<strong>「黒い丸」</strong>の動き全体の印象を評価してください。</p>
     `,
   choices: ['開始する']
  });
